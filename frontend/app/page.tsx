...
export default function StaffShiftsPage() {
    ...
    const initialMonth = today.getMonth() + 1; // getMonth()は0から始まるため +1
    ...
    }, [currentYear, currentMonth, fetchShifts]);


    // Calendarコンポーネントに渡すためのシフトデータ形式への変換 (Calendar.tsxと同じ構造)
