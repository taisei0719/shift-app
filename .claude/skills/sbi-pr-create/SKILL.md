...
ユーザーから「マージした」と報告されたら（チャット、または `#bestshift-dev` でのSlack返信のいずれでも可）、`gh pr view <PR番号> --json state,mergedAt` でマージ済みを確認したうえで、以下を行う（[docs/workflow.md](../../../docs/workflow.md) 2章7参照）。
